      ...
      <div id="instructions-container">
        ...
        {slack_code ? (
          ...
          <>
            ...
            <p>
              Afterwards, Slack will send you back to this page. See you soon!
            </p>
        ...
        <p>
          1. Create the slack channel you want to use Spacetube in. It's
          convenient to name it after the group you're going to talk to.
        </p>
        <p>
          2. Invite @spacetube to the channel. You can use{" "}
          <span>/invite @spacetube</span>.
        </p>
        ...
        <p>
          ...
          Slack channel. It should look like{" "}
          <span>@spacetube invite-code-here</span>
        </p>
        <p className="center">OR</p>
        <h3 className="center">Create a new tube</h3>
        <p>
          1. Send <span>@spacetube</span> in the Slack channel to make a new
          tube! Spacetube will make a new invite code for you. You can customise
          your invite code by sending{" "}
        ...
        <p>
          ...
          in the Slack channel and everything after @spacetube will be forwarded
          to those in the tube.
        </p>
        <h2>Happy tubing!</h2>
      </div>
    </div>
